...
![Version: 0.1.16](https://img.shields.io/badge/Version-0.1.16-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.13.1](https://img.shields.io/badge/AppVersion-9.13.1-informational?style=flat-square)
...
| image.repository | string | `"zwavejs/zwave-js-ui"` | Container image repository |
...
| service.ports.websocket | object | `{"port":3000}` | Websocket port |
...
| persistence | object | `{"config":{"enabled":false,"mountPath":"/usr/src/app/store","size":"1Gi","type":"pvc"}}` | [Persistence](https://jasonb5.github.io/charts/site/guide/common-library/#persistence) |
...
| persistence.config.mountPath | string | `"/usr/src/app/store"` | Volume mount path |

{%
include-markdown "../../charts/zwave-js-ui/CUSTOM.md"
%}
