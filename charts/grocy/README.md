...
![Version: 0.1.6](https://img.shields.io/badge/Version-0.1.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.2.0](https://img.shields.io/badge/AppVersion-4.2.0-informational?style=flat-square)
...
* <https://github.com/jasonb5/charts/tree/main/charts/grocy>
...
| image.repository | string | `"ghcr.io/linuxserver/grocy"` | Container image repository |
...
{%
include-markdown "../../charts/grocy/CUSTOM.md"
%}
