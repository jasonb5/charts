...
| addons.rclone.env.CUSTOM_COMMAND | str | `nil` | Custom command overrides `rclone sync ${SOURCE} ${DESTINATION}`. |
| addons.rclone.image | object | `{"repository":"ghcr.io/jasonb5/rclone","tag":"0.1.1"}` | Rclone container image |
