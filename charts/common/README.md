...
| addons.codeserver.image.repository | string | `"ghcr.io/linuxserver/code-server"` |  |
| addons.codeserver.image.tag | string | `"4.17.1"` |  |
| addons.codeserver.service.ports.codeserver.port | int | `8443` |  |
| addons.codeserver.ingress.enabled | bool | `false` |  |
| addons.codeserver.ingress.hosts[0].name | string | `"codeserver"` |  |
| addons.codeserver.persistence.config.enabled | bool | `false` |  |
| addons.rclone.enabled | bool | `false` |  |
| addons.rclone.env.CRON | string | `nil` |  |
| addons.rclone.env.SOURCE | string | `nil` |  |
| addons.rclone.env.DESTINATION | string | `nil` |  |
| addons.rclone.env.FLAGS | string | `nil` |  |
| addons.rclone.image.repository | string | `"ghcr.io/jasonb5/rclone"` |  |
| addons.rclone.image.tag | string | `"0.1.0"` |  |
